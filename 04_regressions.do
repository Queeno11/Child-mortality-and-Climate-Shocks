...
reghdfejl child_agedeath_30d  ${prec_previous} ${precipitation}_30d $controls, absorb(year_ID_cell3_* month_ID_cell3_*) vce(cluster ID_cell3_*) gpu
...
reghdfejl child_agedeath_30d  ${prec_previous} ${precipitation}_30d $controls, absorb(year_ID_cell4_* month_ID_cell4_*) vce(cluster ID_cell4_*) gpu
...
reghdfejl child_agedeath_30d3m ${prec_previous} ${precipitation}_30d3m $controls, absorb(year_ID_cell_* month_ID_cell_*) vce(cluster ID_cell_*) gpu
...
reghdfejl child_agedeath_30d3m ${prec_previous} ${precipitation}_30d3m $controls, absorb(year_ID_cell2_* month_ID_cell2_*) vce(cluster ID_cell2_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 1deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_30d3m ${prec_previous} ${precipitation}_30d3m $controls, absorb(year_ID_cell3_* month_ID_cell3_*) vce(cluster ID_cell3_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 2deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_30d3m ${prec_previous} ${precipitation}_30d3m $controls, absorb(year_ID_cell4_* month_ID_cell4_*) vce(cluster ID_cell4_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 4deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)
...
reghdfejl child_agedeath_3m6m ${prec_previous} ${precipitation}_3m6m $controls, absorb(year_ID_cell_* month_ID_cell_*) vce(cluster ID_cell_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 0.5deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_3m6m ${prec_previous} ${precipitation}_3m6m $controls, absorb(year_ID_cell2_* month_ID_cell2_*) vce(cluster ID_cell2_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 1deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_3m6m ${prec_previous} ${precipitation}_3m6m $controls, absorb(year_ID_cell3_* month_ID_cell3_*) vce(cluster ID_cell3_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 2deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_3m6m ${prec_previous} ${precipitation}_3m6m $controls, absorb(year_ID_cell4_* month_ID_cell4_*) vce(cluster ID_cell4_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 4deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)
...
reghdfejl child_agedeath_6m12m ${prec_previous} ${precipitation}_6m12m $controls, absorb(year_ID_cell_* month_ID_cell_*) vce(cluster ID_cell_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 0.5deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_6m12m ${prec_previous} ${precipitation}_6m12m $controls, absorb(year_ID_cell2_* month_ID_cell2_*) vce(cluster ID_cell2_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 1deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_6m12m ${prec_previous} ${precipitation}_6m12m $controls, absorb(year_ID_cell3_* month_ID_cell3_*) vce(cluster ID_cell3_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 2deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_6m12m ${prec_previous} ${precipitation}_6m12m $controls, absorb(year_ID_cell4_* month_ID_cell4_*) vce(cluster ID_cell4_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_prec${historic_means}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 4deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)


reghdfejl child_agedeath_30d  drought_q1 drought_q2 drought_q3 drought_30d excessiverain_q1 excessiverain_q2 excessiverain_q3 excessiverain_30d $controls, absorb(month_ID_cell ID_cell_year) vce(cluster ID_cell_*) gpu

reghdfejl child_agedeath_30d3m drought_q1 drought_q2 drought_q3 drought_30d drought_30d3m excessiverain_q1 excessiverain_q2 excessiverain_q3 excessiverain_30d excessiverain_30d3m $controls, absorb(month_ID_cell ID_cell_year) vce(cluster ID_cell_*) gpu if child_agedeath_30d==0

   
**# Models with thresholds

foreach threshold in "2_5" "3_0" "3_5" "4_0" {
...
* 	reghdfejl child_agedeath_{p}  ${drought_previous} ${drought}_{age} ${excessiverain_previous} ${excessiverain}_{p} $controls, absorb(i.chb_month#i.ID_country) vce(cluster i.ID_country)
...
reghdfejl child_agedeath_30d  ${drought_previous} ${drought}_30d ${excessiverain_previous} ${excessiverain}_30d  $controls, absorb(month_ID_cell ID_cell_year) vce(cluster ID_cell_*) gpu
...
reghdfejl child_agedeath_30d  ${drought_previous} ${drought}_30d ${excessiverain_previous} ${excessiverain}_30d $controls, absorb(year_ID_cell2_* month_ID_cell2_*) vce(cluster ID_cell2_*) gpu
...
reghdfejl child_agedeath_30d  ${drought_previous} ${drought}_30d ${excessiverain_previous} ${excessiverain}_30d $controls, absorb(year_ID_cell3_* month_ID_cell3_*) vce(cluster ID_cell3_*) gpu
...
reghdfejl child_agedeath_30d  ${drought_previous} ${drought}_30d ${excessiverain_previous} ${excessiverain}_30d $controls, absorb(year_ID_cell4_* month_ID_cell4_*) vce(cluster ID_cell4_*) gpu
...
reghdfejl child_agedeath_30d3m ${drought_previous} ${drought}_30d3m ${excessiverain_previous} ${excessiverain}_30d3m $controls, absorb(year_ID_cell_* month_ID_cell_*) vce(cluster ID_cell_*) gpu
...
reghdfejl child_agedeath_30d3m ${drought_previous} ${drought}_30d3m ${excessiverain_previous} ${excessiverain}_30d3m $controls, absorb(year_ID_cell2_* month_ID_cell2_*) vce(cluster ID_cell2_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 1deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_30d3m ${drought_previous} ${drought}_30d3m ${excessiverain_previous} ${excessiverain}_30d3m $controls, absorb(year_ID_cell3_* month_ID_cell3_*) vce(cluster ID_cell3_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 2deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_30d3m ${drought_previous} ${drought}_30d3m ${excessiverain_previous} ${excessiverain}_30d3m $controls, absorb(year_ID_cell3_* month_ID_cell4_*) vce(cluster ID_cell4_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 4deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)
...
reghdfejl child_agedeath_3m6m ${drought_previous} ${drought}_3m6m ${excessiverain_previous} ${excessiverain}_3m6m $controls, absorb(year_ID_cell_* month_ID_cell_*) vce(cluster ID_cell_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 0.5deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_3m6m ${drought_previous} ${drought}_3m6m ${excessiverain_previous} ${excessiverain}_3m6m $controls, absorb(year_ID_cell2_* month_ID_cell2_*) vce(cluster ID_cell2_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 1deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_3m6m ${drought_previous} ${drought}_3m6m ${excessiverain_previous} ${excessiverain}_3m6m $controls, absorb(year_ID_cell3_* month_ID_cell3_*) vce(cluster ID_cell3_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 2deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_3m6m ${drought_previous} ${drought}_3m6m ${excessiverain_previous} ${excessiverain}_3m6m $controls, absorb(year_ID_cell4_* month_ID_cell4_*) vce(cluster ID_cell4_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 4deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)
...
reghdfejl child_agedeath_6m12m ${drought_previous} ${drought}_6m12m ${excessiverain_previous} ${excessiverain}_6m12m $controls, absorb(year_ID_cell_* month_ID_cell_*) vce(cluster ID_cell_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 0.5deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_6m12m ${drought_previous} ${drought}_6m12m ${excessiverain_previous} ${excessiverain}_6m12m $controls, absorb(year_ID_cell2_* month_ID_cell2_*) vce(cluster ID_cell2_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 1deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_6m12m ${drought_previous} ${drought}_6m12m ${excessiverain_previous} ${excessiverain}_6m12m $controls, absorb(year_ID_cell3_* month_ID_cell3_*) vce(cluster ID_cell3_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 2deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)

reghdfejl child_agedeath_6m12m ${drought_previous} ${drought}_6m12m ${excessiverain_previous} ${excessiverain}_6m12m $controls, absorb(year_ID_cell4_* month_ID_cell4_*) vce(cluster ID_cell4_*) gpu
outreg2 using "$OUTPUTS/regression_outs_timetend_${historic_means}_${threshold}", tex excel label append addtext(Time trend, Yes, Cell#Month FE, Yes, Cell size, 4deg)  nonotes addnote(SE clustered by Cell, *p<.05; **p<.01; ***p<.001)
